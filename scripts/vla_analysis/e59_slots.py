...
OUT_DIR = "/home/josh/lerobot/outputs/analysis/e59"
...
all_res = {}
with open(os.path.join(OUT_DIR, "slots_e59.out"), "w") as fh:
    for name, d in RUNS.items():
        all_res[name] = analyze(name, d, fh)
json.dump(all_res, open(os.path.join(OUT_DIR, "slots_e59.json"), "w"))
print("done; wrote", OUT_DIR + "/slots_e59.{out,json}")
