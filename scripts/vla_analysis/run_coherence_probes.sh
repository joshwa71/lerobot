...
run_one () {  # $1=run_dir $2=ckpts $3=a_ckpt $4=tag
  ...
  export PROBE_RUN_DIR=$RD PROBE_CKPTS=$2 PROBE_A_CKPT=$3 PROBE_OUT=$SP/probe_coherence.jsonl
  python $SCRIPTS/probe_coherence.py \
...
echo "ALL COHERENCE PROBES DONE"
