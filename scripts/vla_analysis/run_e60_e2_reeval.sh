...
CKPT=$ROOT/outputs/train/libero_10_seq5_jw_bigsearch_e4to16_v5to13_prepass_beta4corefrac_topt3072_lr2x_steps5k/checkpoints/025000/pretrained_model
...
D=$ROOT/outputs/analysis/e60/e2_reeval_seed2000
rm -rf "$D"
lerobot-eval \
  --policy.path="$CKPT" \
