#!/usr/bin/env python3
"""E52 slot autopsy: fold-in vs comp vs layermax-plain.
...
OUT_DIR = "/home/josh/lerobot/outputs/analysis/e52"
...
all_res = {}
with open(os.path.join(OUT_DIR, "slots_e52.out"), "w") as fh:
    for name, d in RUNS.items():
        all_res[name] = analyze(name, d, fh)
json.dump(all_res, open(os.path.join(OUT_DIR, "slots_e52.json"), "w"))
print("done; wrote", OUT_DIR + "/slots_e52.{out,json}")
