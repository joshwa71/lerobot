...
run_one () {  # $1=run_dir $2=ckpts $3=a_ckpt $4=tag
  ...
  export PROBE_RUN_DIR=$RD PROBE_CKPTS=$2 PROBE_A_CKPT=$3 PROBE_OUT=$SP/probe_offbridge.jsonl
  python $SCRIPTS/probe_offbridge.py \
...
run_one $STGB "t0:025000,t2:025000,t3:025000" "" stageB
run_one $LR2X "t0:005000,t2:015000,t3:020000" "" lr2x
run_one $S7K  "t0:007000,t2:021000,t3:028000" "" steps7k
run_one $R2244 "t0:050000,t2:050000,t3:050000" "" r2244
echo "ALL OFFBRIDGE PROBES DONE"
