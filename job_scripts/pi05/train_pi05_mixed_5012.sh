cat > train_pi05_mixed_5012_libero_10_100k.sh << 'EOF'
#!/bin/bash
#$ -S /bin/bash
#$ -l tmem=64G
#$ -l h_rt=72:00:00
...
#$ -R y
#$ -l tscratch=200G
#$ -N pi05_mixed_5012_libero_10_100k_train
...
FINAL_OUTPUT_DIR="/SAN/vision/jo71_vla_wd/lerobot/outputs/train/mixed_libero_10_pi05_100k_5012"
...
accelerate launch \
  ...
  --policy.repo_id=outputs/train/mixed_libero_10_pi05_100k_5012 \
  ...
  --job_name=mixed_libero_10_pi05_100k_5012 \
  --wandb.enable=true
