cat > train_pi05_mixed_libero_10_100k_curric_5050.sh << 'EOF'
#!/bin/bash
#$ -S /bin/bash
#$ -l tmem=64G
#$ -l h_rt=72:00:00
...
#$ -R y
#$ -l tscratch=200G
#$ -N pi05_mixed_libero_10_100k_curric_5050_train
...
accelerate launch \
  ...
  --policy.repo_id=outputs/train/mixed_libero_10_pi05_100k_curric_5050 \
