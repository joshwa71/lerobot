cat > train_pi05_mixed_5012_libero_10_100k_state_dropout.sh << 'EOF'
#!/bin/bash
#$ -S /bin/bash
#$ -l tmem=64G
#$ -l h_rt=72:00:00
...
#$ -R y
#$ -l tscratch=200G
#$ -N pi05_mixed_5012_libero_10_100k_state_dropout_train
...
OUTPUT_SCRATCH="$SCRATCH_DIR/outputs/train/mixed_libero_10_pi05_100k_5012_state_dropout"
FINAL_OUTPUT_DIR="/SAN/vision/jo71_vla_wd/lerobot/outputs/train/mixed_libero_10_pi05_100k_5012_state_dropout"
...
accelerate launch \
  ...
  --policy.repo_id=outputs/train/mixed_libero_10_pi05_100k_5012_state_dropout \
  ...
  --job_name=mixed_libero_10_pi05_100k_5012_state_dropout \
  --wandb.enable=true \
