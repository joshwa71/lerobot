cat > train_smolvla_mixed_libero_10_100k.sh << 'EOF'
#!/bin/bash
#$ -S /bin/bash
#$ -l tmem=64G
#$ -l h_rt=72:00:00
...
#$ -R y
#$ -l tscratch=100G
#$ -N smolvla_mixed_libero_10_100k_train
...
OUTPUT_SCRATCH="$SCRATCH_DIR/outputs/train/mixed_libero_10_smolvla_100k"
...
lerobot-train \
  ...
  --policy.repo_id=outputs/train/mixed_libero_10_smolvla_100k \
...
FINAL_OUTPUT_DIR="/SAN/vision/jo71_vla_wd/lerobot/outputs/train/mixed_libero_10_smolvla_100k"
