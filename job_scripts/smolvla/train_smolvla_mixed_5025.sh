cat > train_smolvla_mixed_5025_libero_10_100k.sh << 'EOF'
#!/bin/bash
#$ -S /bin/bash
#$ -l tmem=64G
#$ -l h_rt=72:00:00
...
#$ -R y
#$ -l tscratch=100G
#$ -N smolvla_mixed_5025_libero_10_100k_train
...
DATASET_SOURCE="/SAN/vision/jo71_vla_wd/lerobot/outputs/mixed_libero_10_5025"
DATASET_SCRATCH="$SCRATCH_DIR/data/mixed_libero_10_5025"
...
OUTPUT_SCRATCH="$SCRATCH_DIR/outputs/train/mixed_libero_10_5025_smolvla_100k"
...
lerobot-train \
  ...
  --policy.repo_id=outputs/train/mixed_libero_10_5025_smolvla_100k \
  ...
  --job_name=mixed_libero_10_5025_smolvla_100k \
  --wandb.enable=true

# Copy outputs back to permanent storage
echo "Copying outputs back to permanent storage..."
FINAL_OUTPUT_DIR="/SAN/vision/jo71_vla_wd/lerobot/outputs/train/mixed_libero_10_5025_smolvla_100k"
