cat > train_smolvla_libero_35_lora.sh << 'EOF'
#!/bin/bash
#$ -S /bin/bash
#$ -l tmem=64G
#$ -l h_rt=72:00:00
...
OUTPUT_SCRATCH="$SCRATCH_DIR/outputs/train/smolvla_libero_35_lora"
FINAL_OUTPUT_DIR="/SAN/vision/jo71_vla_wd/lerobot_meta/outputs/train/smolvla_libero_35_lora"
