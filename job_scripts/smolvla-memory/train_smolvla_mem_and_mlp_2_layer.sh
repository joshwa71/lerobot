cat > memory_libero_95_mem_mlp_512_2_layer.sh << 'EOF'
#!/bin/bash
#$ -S /bin/bash
#$ -l tmem=64G
#$ -l h_rt=96:00:00
...
#$ -R y
#$ -l tscratch=200G
#$ -N memory_libero_95_mem_mlp_512_2_layer
...
lerobot-train \
  ...
  --policy.repo_id=outputs/train/memory_libero_95_mem_mlp_512_2_layer \
  ...
  --job_name=memory_libero_95_mem_mlp_512_2_layer \
