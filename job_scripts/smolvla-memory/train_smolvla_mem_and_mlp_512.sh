...
OUTPUT_SCRATCH="$SCRATCH_DIR/outputs/train/smolvla_libero_90_mem_mlp_512"
# Final output target (used by trap for sync-back)
FINAL_OUTPUT_DIR="/SAN/vision/jo71_vla_wd/lerobot_memory/outputs/train/smolvla_libero_90_mem_mlp_512"
...
lerobot-train \
  ...
  --policy.repo_id=outputs/train/smolvla_libero_90_mem_mlp_512 \
  ...
  --job_name=smolvla_libero_90_mem_mlp_512 \
