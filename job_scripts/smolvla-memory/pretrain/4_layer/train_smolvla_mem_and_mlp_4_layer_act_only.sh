cat > memory_libero_95_mem_mlp_512_4_layer_act_only.sh << 'EOF'
#!/bin/bash
#$ -S /bin/bash
#$ -l tmem=64G
#$ -l h_rt=120:00:00
...
#$ -R y
#$ -l tscratch=200G
#$ -N memory_libero_95_mem_mlp_512_4_layer_act_only
...
OUTPUT_SCRATCH="$SCRATCH_DIR/outputs/train/memory_libero_95_mem_mlp_512_4_layer_act_only"
# Final output target (used by trap for sync-back)
FINAL_OUTPUT_DIR="/SAN/vision/jo71_vla_wd/lerobot_memory/outputs/train/memory_libero_95_mem_mlp_512_4_layer_act_only"
...
lerobot-train \
  ...
  --policy.repo_id=outputs/train/memory_libero_95_mem_mlp_512_4_layer_act_only \
  ...
  --job_name=memory_libero_95_mem_mlp_512_4_layer_act_only \
