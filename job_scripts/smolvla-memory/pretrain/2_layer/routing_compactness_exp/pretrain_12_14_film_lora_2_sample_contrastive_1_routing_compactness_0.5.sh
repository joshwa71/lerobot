cat > pretrain_12_14_film_lora_2_sample_contrastive_1_routing_compactness_0.5.sh << 'INNER_EOF'
#!/bin/bash
#$ -S /bin/bash
#$ -l tmem=64G
#$ -l h_rt=72:00:00
...
#$ -R y
#$ -l tscratch=200G
#$ -N pretrain_12_14_film_lora_2_sample_contrastive_1_routing_compactness_0.5
...
OUTPUT_SCRATCH="$SCRATCH_DIR/outputs/train/libero_95_12_14_film_lora_2_sample_contrastive_1_routing_compactness_0.5"
# Final output target (used by trap for sync-back)
FINAL_OUTPUT_DIR="/SAN/vision/jo71_vla_wd/lerobot_memory/outputs/train/libero_95_12_14_film_lora_2_sample_contrastive_1_routing_compactness_0.5"
...
lerobot-train \
  ...
  --policy.repo_id=outputs/train/libero_95_12_14_film_lora_2_sample_contrastive_1_routing_compactness_0.5 \
  ...
  --job_name=libero_95_12_14_film_lora_2_sample_contrastive_1_routing_compactness_0.5 \
  ...
  --policy.memory_layer.routing_compactness_weight=0.5
