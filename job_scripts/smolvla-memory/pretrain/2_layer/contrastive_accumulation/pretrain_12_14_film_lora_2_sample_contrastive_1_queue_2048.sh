...
#$ -R y
#$ -l tscratch=200G
#$ -N pretrain_12_14_film_lora_2_sample_contrastive_1_queue_2048
...
OUTPUT_SCRATCH="$SCRATCH_DIR/outputs/train/libero_95_12_14_film_lora_2_sample_contrastive_1_queue_2048"
# Final output target (used by trap for sync-back)
FINAL_OUTPUT_DIR="/SAN/vision/jo71_vla_wd/lerobot_memory/outputs/train/libero_95_12_14_film_lora_2_sample_contrastive_1_queue_2048"
...
lerobot-train \
  ...
  --policy.repo_id=outputs/train/libero_95_12_14_film_lora_2_sample_contrastive_1_queue_2048 \
  ...
  --job_name=libero_95_12_14_film_lora_2_sample_contrastive_1_queue_2048 \
  ...
  --policy.memory_layer.contrastive_query_queue=2048 \
