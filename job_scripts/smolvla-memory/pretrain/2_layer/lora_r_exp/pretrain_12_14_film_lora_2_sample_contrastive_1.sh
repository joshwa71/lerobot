...
#$ -R y
#$ -l tscratch=200G
#$ -N pretrain_12_14_film_lora_2_sample_contrastive_1
...
OUTPUT_SCRATCH="$SCRATCH_DIR/outputs/train/libero_95_12_14_film_lora_2_sample_contrastive_1"
# Final output target (used by trap for sync-back)
FINAL_OUTPUT_DIR="/SAN/vision/jo71_vla_wd/lerobot_memory/outputs/train/libero_95_12_14_film_lora_2_sample_contrastive_1"
...
lerobot-train \
  ...
  --policy.repo_id=outputs/train/libero_95_12_14_film_lora_2_sample_contrastive_1 \
  ...
  --job_name=libero_95_12_14_film_lora_2_sample_contrastive_1 \
