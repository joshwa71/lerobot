cat > smolvla_pretrain_train_3_wide_lora_contrastive.sh << 'EOF'
#!/bin/bash
#$ -S /bin/bash
#$ -l tmem=64G
#$ -l h_rt=72:00:00
...
OUTPUT_SCRATCH="$SCRATCH_DIR/outputs/train/libero_95_3_wide_lora_contrastive"
# Final output target (used by trap for sync-back)
FINAL_OUTPUT_DIR="/SAN/vision/jo71_vla_wd/lerobot_memory/outputs/train/libero_95_3_wide_lora_contrastive"
...
lerobot-train \
  ...
  --policy.repo_id=outputs/train/libero_95_3_wide_lora_contrastive \
  ...
  --job_name=libero_95_3_wide_lora_contrastive \
