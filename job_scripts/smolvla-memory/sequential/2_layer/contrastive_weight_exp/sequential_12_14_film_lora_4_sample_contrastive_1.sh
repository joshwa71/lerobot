...
#$ -R y
#$ -l tscratch=200G
#$ -N sequential_12_14_film_lora_4_sample_contrastive_1
...
OUTPUT_SCRATCH="$SCRATCH_DIR/outputs/train/sequential_libero_95_12_14_film_lora_4_sample_contrastive_1"
# Final output target (used by trap for sync-back)
FINAL_OUTPUT_DIR="/SAN/vision/jo71_vla_wd/lerobot_memory/outputs/train/sequential_libero_95_12_14_film_lora_4_sample_contrastive_1"
...
python -m lerobot.scripts.lerobot_sequential_train \
  ...
  --job_name=sequential_libero_10_smolvla_12_14_film_lora_4_sample_contrastive_1 \
