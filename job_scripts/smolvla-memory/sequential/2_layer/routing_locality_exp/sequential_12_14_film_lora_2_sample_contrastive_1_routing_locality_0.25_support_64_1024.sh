cat > sequential_12_14_film_lora_2_sample_contrastive_1_routing_locality_0.25_support_64_1024.sh << 'INNER_EOF'
#!/bin/bash
#$ -S /bin/bash
#$ -l tmem=64G
#$ -l h_rt=72:00:00
...
#$ -R y
#$ -l tscratch=200G
#$ -N sequential_libero_95_12_14_film_lora_2_sample_contrastive_1_routing_locality_0.25_support_64_1024
...
MODEL_SOURCE="/SAN/vision/jo71_vla_wd/lerobot_memory/outputs/train/libero_95_12_14_film_lora_2_sample_contrastive_1_routing_locality_0.25_support_64_1024"
MODEL_SCRATCH="$SCRATCH_DIR/libero_95_12_14_film_lora_2_sample_contrastive_1_routing_locality_0.25_support_64_1024"
...
OUTPUT_SCRATCH="$SCRATCH_DIR/outputs/train/sequential_libero_95_12_14_film_lora_2_sample_contrastive_1_routing_locality_0.25_support_64_1024"
FINAL_OUTPUT_DIR="/SAN/vision/jo71_vla_wd/lerobot_memory/outputs/train/sequential_libero_95_12_14_film_lora_2_sample_contrastive_1_routing_locality_0.25_support_64_1024"
...
python -m lerobot.scripts.lerobot_sequential_train \
  ...
  --job_name=sequential_libero_10_smolvla_libero_95_12_14_film_lora_2_sample_contrastive_1_routing_locality_0.25_support_64_1024 \
