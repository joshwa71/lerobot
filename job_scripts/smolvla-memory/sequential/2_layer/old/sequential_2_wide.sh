cat > smolvla_sequential_train_2_wide.sh << 'EOF'
#!/bin/bash
#$ -S /bin/bash
#$ -l tmem=64G
#$ -l h_rt=72:00:00
...
#$ -R y
#$ -l tscratch=200G
#$ -N smolvla_sequential_train_2_wide
...
MODEL_SOURCE="/SAN/vision/jo71_vla_wd/lerobot_memory/outputs/train/memory_libero_95_mem_mlp_512_2_layer_wide"
MODEL_SCRATCH="$SCRATCH_DIR/memory_libero_95_mem_mlp_512_2_layer_wide"
...
OUTPUT_SCRATCH="$SCRATCH_DIR/outputs/train/libero_10_smolvla_sequential_2_wide"
# Final output target (used by trap for sync-back)
FINAL_OUTPUT_DIR="/SAN/vision/jo71_vla_wd/lerobot_memory/outputs/train/libero_10_smolvla_sequential_2_wide"
...
python -m lerobot.scripts.lerobot_sequential_train \
  ...
  --job_name=libero_10_smolvla_sequential_2_wide \
