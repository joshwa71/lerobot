cat > smolvla_sequential_train_8_10_wide_film_dropout_high_lora_4_sample_contrastive_0.5.sh << 'EOF'
#!/bin/bash
#$ -S /bin/bash
#$ -l tmem=64G
#$ -l h_rt=72:00:00
...
#$ -R y
#$ -l tscratch=200G
#$ -N smolvla_sequential_train_8_10_wide_film_dropout_high_lora_4_sample_contrastive_0.5
...
MODEL_SOURCE="/SAN/vision/jo71_vla_wd/lerobot_memory/outputs/train/libero_95_8_10_wide_film_dropout_high_lora_4_sample_contrastive_0.5"
MODEL_SCRATCH="$SCRATCH_DIR/libero_95_8_10_wide_film_dropout_high_lora_4_sample_contrastive_0.5"
...
OUTPUT_SCRATCH="$SCRATCH_DIR/outputs/train/sequential_libero_95_8_10_wide_film_dropout_high_lora_4_sample_contrastive_0.5"
# Final output target (used by trap for sync-back)
FINAL_OUTPUT_DIR="/SAN/vision/jo71_vla_wd/lerobot_memory/outputs/train/sequential_libero_95_8_10_wide_film_dropout_high_lora_4_sample_contrastive_0.5"
...
python -m lerobot.scripts.lerobot_sequential_train \
  ...
  --job_name=sequential_libero_10_smolvla_8_10_wide_film_dropout_high_lora_4_sample_contrastive_0.5 \
