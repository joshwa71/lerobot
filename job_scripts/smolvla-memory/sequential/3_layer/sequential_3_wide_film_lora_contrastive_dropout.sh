cat > smolvla_sequential_train_3_wide_film_lora_contrastive_dropout.sh << 'EOF'
#!/bin/bash
#$ -S /bin/bash
#$ -l tmem=64G
#$ -l h_rt=72:00:00
...
#$ -R y
#$ -l tscratch=200G
#$ -N smolvla_sequential_train_3_wide_film_lora_contrastive_dropout
...
MODEL_SOURCE="/SAN/vision/jo71_vla_wd/lerobot_memory/outputs/train/libero_95_3_wide_film_lora_contrastive_dropout"
MODEL_SCRATCH="$SCRATCH_DIR/libero_95_3_wide_film_lora_contrastive_dropout"
...
OUTPUT_SCRATCH="$SCRATCH_DIR/outputs/train/sequential_libero_95_3_wide_film_lora_contrastive_dropout"
# Final output target (used by trap for sync-back)
FINAL_OUTPUT_DIR="/SAN/vision/jo71_vla_wd/lerobot_memory/outputs/train/sequential_libero_95_3_wide_film_lora_contrastive_dropout"
...
python -m lerobot.scripts.lerobot_sequential_train \
  ...
  --job_name=sequential_libero_10_smolvla_3_wide_film_lora_contrastive_dropout \
  ...
  --idf_exponent=1 \
  --memory_value_lr=0.005 \
  --memory_value_lr_end=0.001 \
