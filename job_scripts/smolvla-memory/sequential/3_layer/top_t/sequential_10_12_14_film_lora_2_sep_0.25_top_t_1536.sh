cat > sequential_10_12_14_film_lora_2_sep_0.25_top_t_1536.sh << 'EOF'
#!/bin/bash
#$ -S /bin/bash
#$ -l tmem=64G
#$ -l h_rt=72:00:00
...
#$ -R y
#$ -l tscratch=200G
#$ -N sequential_10_12_14_sep_0.25_top_t_1536
...
# Copy pretrained model to scratch (same sep=0.25 3-layer pretrain)
...
OUTPUT_SCRATCH="$SCRATCH_DIR/outputs/train/sequential_libero_95_10_12_14_film_lora_2_sep_0.25_top_t_1536"
# Final output target (used by trap for sync-back)
FINAL_OUTPUT_DIR="/SAN/vision/jo71_vla_wd/lerobot_memory/outputs/train/sequential_libero_95_10_12_14_film_lora_2_sep_0.25_top_t_1536"
...
python -m lerobot.scripts.lerobot_sequential_train \
  ...
  --job_name=sequential_libero_10_smolvla_10_12_14_film_lora_2_sep_0.25_top_t_1536 \
