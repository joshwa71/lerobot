...
#$ -R y
#$ -l tscratch=200G
#$ -N sequential_10_12_14_sep_0.25_top_t_768
...
OUTPUT_SCRATCH="$SCRATCH_DIR/outputs/train/sequential_libero_95_10_12_14_film_lora_2_sep_0.25_top_t_768"
# Final output target (used by trap for sync-back)
FINAL_OUTPUT_DIR="/SAN/vision/jo71_vla_wd/lerobot_memory/outputs/train/sequential_libero_95_10_12_14_film_lora_2_sep_0.25_top_t_768"
...
python -m lerobot.scripts.lerobot_sequential_train \
  ...
  --job_name=sequential_libero_10_smolvla_10_12_14_film_lora_2_sep_0.25_top_t_768 \
