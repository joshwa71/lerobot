cat > smolvla_sequential_train_3_wide_film_lora_contrastive_0.2.sh << 'EOF'
#!/bin/bash
#$ -S /bin/bash
#$ -l tmem=64G
#$ -l h_rt=72:00:00
...
#$ -R y
#$ -l tscratch=200G
#$ -N smolvla_sequential_train_3_wide_film_lora_contrastive_0.2
...
MODEL_SOURCE="/SAN/vision/jo71_vla_wd/lerobot_memory/outputs/train/libero_95_3_wide_film_lora_contrastive_0.2"
MODEL_SCRATCH="$SCRATCH_DIR/libero_95_3_wide_film_lora_contrastive_0.2"
...
OUTPUT_SCRATCH="$SCRATCH_DIR/outputs/train/sequential_libero_95_3_wide_film_lora_contrastive_0.2"
# Final output target (used by trap for sync-back)
FINAL_OUTPUT_DIR="/SAN/vision/jo71_vla_wd/lerobot_memory/outputs/train/sequential_libero_95_3_wide_film_lora_contrastive_0.2"
...
python -m lerobot.scripts.lerobot_sequential_train \
  ...
  --job_name=sequential_libero_10_smolvla_3_wide_film_lora_contrastive_0.2 \
