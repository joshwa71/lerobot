cat > train_pi0_libero_10_300k.sh << 'EOF'
#!/bin/bash
#$ -S /bin/bash
#$ -l tmem=64G
#$ -l h_rt=72:00:00
...
lerobot-train \
  ...
  --policy.repo_id=outputs/train/libero_10_pi0_300k \
  --dataset.repo_id=outputs/libero_10 \
  --output_dir=./outputs/train/libero_10_pi0_300k \
  --steps=300000 \
  --batch_size=16 \
  --eval_freq=0 \
  --save_freq=20000 \
