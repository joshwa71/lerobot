...
PRETRAIN_RUN=realworld_pretrain_pi05_8_10_12_14_film_lora_2_sample_contrastive_0.01_sep_0.25_loc_0.25_sup_128_4096_knn_36_50k
SEQ_RUN=realworld_sequential_pi05_8_10_12_14_film_lora_2_sample_contrastive_0.01_sep_0.25_loc_0.25_sup_128_4096_knn_36_50k
...
if [ -d "$PRETRAIN_CHECKPOINT" ]; then
  ...
  lerobot-train \
    ...
    --policy.memory_layer.routing_intra_task_max_support=4096 \
